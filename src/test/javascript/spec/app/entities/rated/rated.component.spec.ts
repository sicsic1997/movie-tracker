...
import { RatedComponent } from 'app/entities/rated/rated.component';
import { RatedService } from 'app/entities/rated/rated.service';
import { Rated } from 'app/shared/model/rated.model';

describe('Component Tests', () => {
    describe('Rated Management Component', () => {
        let comp: RatedComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(RatedComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.rateds[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
