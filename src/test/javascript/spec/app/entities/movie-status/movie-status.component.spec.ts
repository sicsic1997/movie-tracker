...
import { MovieStatusComponent } from 'app/entities/movie-status/movie-status.component';
...
describe('Component Tests', () => {
    describe('MovieStatus Management Component', () => {
        let comp: MovieStatusComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [MovieStatusComponent],
                providers: [
                    {
                ...
                .overrideTemplate(MovieStatusComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.movieStatuses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
