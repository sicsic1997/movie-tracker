...
export class SimilarityComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.similarityService
            ...
            .subscribe(
                (res: HttpResponse<ISimilarity[]>) => this.paginateSimilarities(res.body, res.headers),
    ...
    trackId(index: number, item: ISimilarity) {
        return item.id;
    }

    registerChangeInSimilarities() {
        this.eventSubscriber = this.eventManager.subscribe('similarityListModification', response => this.loadAll());
    }
    ...
    protected paginateSimilarities(data: ISimilarity[], headers: HttpHeaders) {
